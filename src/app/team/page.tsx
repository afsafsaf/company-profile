...
const url2 = "https://randomuser.me/api?results=3";
...
export default async function Team() {
  ...
  return (
    <>
      ...
      <div>
        <p className=" mt-5 text-xl w-1/2 mx-auto text-center font-bold bg-slate-600 rounded-xl backdrop-blur-sm opacity-95">
          Managerial
        </p>
        <div className="mt-5 grid md:grid-cols-3 grid-cols-1 m-5 gap-5 mx-auto text-center">
          {results2.map(
            (
              result: {
                picture: { large: string };
      ...
      {/* STAFF */}
      <div>
        <p className=" w-1/2 text-xl mx-auto text-center font-bold bg-slate-600 rounded-xl backdrop-blur-sm opacity-95">
          STAFF
        </p>
      </div>
